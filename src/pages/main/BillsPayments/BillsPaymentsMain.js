        ...
        <>
            <div className="page-header d-flex align-items-center justify-content-between">
                ...
                <div>
                    ...
                    <Button className="btn-create-bill font-manrope-regular" type="primary" onClick={() => props.history.push("/main/bills-payments/create")}>Создать платёж <span className="icon icon-plus"/></Button>
                </div>
            </div>
...
export default BillsPaymentsMain;