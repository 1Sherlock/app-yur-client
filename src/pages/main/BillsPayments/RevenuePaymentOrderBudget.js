...
const RevenuePaymentOrderBudget = () => {
    return (
        <div className="bills-page-payment-order">
            ...
            <div className="payer-info recipient">
                <div className="row">
                    ...
                    <div className="col-md-6">
                        <div className="info-group">
                            <label htmlFor="document_date">Казначейский лицевой счет дохода</label>
                            <InputNumber placeholder="Казначейский лицевой счет дохода" id="document_date"  style={{width: "100%"}}/>
                        </div>
                    </div>
                    <div className="col-md-6">
                        <div className="info-group">
                            <label htmlFor="bank_name2">Наименование лицевого счета дохода:</label>
                            <Input placeholder="Наименование лицевого счета дохода:" id="bank_name2"  style={{width: "100%"}}/>
                        </div>
                    </div>
                    <div className="col-md-3">
                        <div className="info-group">
                            <label htmlFor="tranche_code">Регион</label>
                            <Input placeholder="Регион" id="tranche_code"  style={{width: "100%"}}/>
                        </div>
                    </div>
                    ...
                    <div className="col-md-3">
                        <div className="info-group">
                            <label htmlFor="tranche_code">Соато</label>
                            <Input placeholder="Соато" id="tranche_code"  style={{width: "100%"}}/>
                        </div>
                    </div>
                    <div className="col-md-9">
                        <div className="info-group">
                            <label htmlFor="tranche_code2">Соато</label>
                            <Input placeholder="Соато" id="tranche_code2"  style={{width: "100%"}}/>
                        </div>
                    </div>
                    <div className="col-md-3">
                        <div className="info-group">
...
export default RevenuePaymentOrderBudget;